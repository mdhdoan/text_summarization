...
def doc_detail(document_path_list):
    ...
    for sentence in sentence_list:
        ...
        word_stop_list = [word for word in word_list if not word.lower() in all_stopwords]
            ...
            if word.isalpha():
                ...
                if lemmatized_word != word:
                    ...
                    if lemmatized_word in term_freq:
                        term_freq[lemmatized_word] += word_stop_list.count(word)
                    else:
                        term_freq[lemmatized_word] = word_stop_list.count(word)
                else: 
                    if word in doc_freq:
                    ...
                    if word in term_freq:
                        term_freq[word] += word_stop_list.count(word)
                    else:
                        term_freq[word] = word_stop_list.count(word)
